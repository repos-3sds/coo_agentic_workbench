...
def main():
        ...
        notifications_json=json.dumps([
            {
                ...
                "recipient_email": "rm.test@dbs.com",
                "recipient_role": "RM",
            ...
            },
            {
                ...
                "recipient_email": "mgr.test@dbs.com",
    ...
    complete_result = sa1_complete_node(
        ...
        input_snapshot=json.dumps({
            "submission_source": "EMAIL",
            "raw_payload": {"sender_email": "rm.test@dbs.com"},
        }),
