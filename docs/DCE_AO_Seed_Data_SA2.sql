-- ============================================================================
-- DCE Account Opening — Seed Data for SA-2 (Document Collection Agent)
-- ============================================================================
-- Version : 1.0.0
-- Date    : 2026-03-02
-- Database: MariaDB (ABS OpenShift)
-- Scope   : 6 cases that reached N-1 from SA-1 seed data
-- Depends : DCE_AO_Seed_Data.sql (SA-1 seed data must be loaded first)
--           DCE_AO_Table_Schemas_SA2.md (SA-2 DDL must be executed first)
-- ============================================================================

-- From the 10 SA-1 cases, these 5 reached N-1 (current_node = N-1 or beyond):
--   AO-2026-000101 — INSTITUTIONAL_FUTURES | CORP  | SGP | Complete docs
--   AO-2026-000104 — COMMODITIES_PHYSICAL  | CORP  | CHN | Complete docs (with translations)
--   AO-2026-000105 — MULTI_PRODUCT         | FUND  | SGP | Complete docs (extensive)
--   AO-2026-000106 — INSTITUTIONAL_FUTURES  | FI    | HKG | Complete docs (regulatory)
--   AO-2026-000108 — RETAIL_FUTURES         | INDIV | HKG | Missing docs → retry
--
-- Plus 1 retry scenario seeded as attempt 2:
--   AO-2026-000101 is shown at attempt 1 (complete)
--   AO-2026-000108 is shown at attempt 1 (incomplete → chase) AND attempt 2 (complete)
...
VALUES
    -- CASE 101: INSTITUTIONAL_FUTURES | CORP | SGP
    (1, 'AO-2026-000101', 1,
    ...
    -- CASE 104: COMMODITIES_PHYSICAL | CORP | CHN
    (2, 'AO-2026-000104', 1,
    ...
    -- CASE 105: MULTI_PRODUCT | FUND | SGP
    (3, 'AO-2026-000105', 1,
    ...
    -- CASE 106: INSTITUTIONAL_FUTURES | FI | HKG
    (4, 'AO-2026-000106', 1,
    ...
    -- CASE 108: RETAIL_FUTURES | INDIVIDUAL | HKG — Attempt 1 (incomplete)
    (5, 'AO-2026-000108', 1,
    ...
    -- CASE 108: Attempt 2 (after RM resubmission)
    (6, 'AO-2026-000108', 2,
     'RETAIL_FUTURES', 'HKG', 'INDIVIDUAL',
     '["FUTURES"]',
     'KB2-v3.1', 6, 2,
...
VALUES
    ...
    -- CASE 108 Attempt 1: 6 mandatory + 2 optional = 8 items (2 docs submitted, gaps exist)
    ...
    -- CASE 108 Attempt 2: Same 8 items — now all mandatory matched after RM resubmission
...
VALUES
    ...
    (2, 'DOC-000002', 'AO-2026-000101', 'CORPORATE_PROFILE', 0.930,
     'CORPORATE PROFILE\nABC Trading Pte Ltd\n\nCERTIFICATE OF INCORPORATION\nCompany Registration No: 201012345A\nDate of Incorporation: 15 June 2010\nIssued by: Accounting and Corporate Regulatory Authority (ACRA)\n\nBOARD RESOLUTION\nResolved that the Company shall open an account with ABS Bank Ltd...\nResolved on: 28 February 2026\n\nMEMORANDUM AND ARTICLES OF ASSOCIATION\n[Full M&A text...]\n\nDIRECTORS:\n1. John Tan Wei Ming — NRIC SXXXX123A — Appointed 2010\n2. Sarah Lim — NRIC SXXXX456B — Appointed 2015\n3. Ahmad bin Hassan — NRIC SXXXX789C — Appointed 2020',
    ...
    -- CASE 108 Attempt 1: 2 documents OCR'd
    ...
    -- CASE 108 Attempt 2: 4 new documents OCR'd (resubmitted by RM)
...
VALUES
    -- CASE 101: All documents ACCEPTED
    ...
    -- CASE 108 Attempt 1: 2 ACCEPTED, 4 effectively MISSING (no review row for missing docs)
    ...
    -- CASE 108 Attempt 2: All 6 submitted docs ACCEPTED
...
VALUES
    -- CASE 101: Complete — proceed to N-2
    ...
    -- CASE 104: Complete — proceed to N-2
    ...
    -- CASE 105: Complete — proceed to N-2
    ...
    -- CASE 106: Complete — proceed to N-2
    ...
    -- CASE 108 Attempt 1: INCOMPLETE — 4 mandatory missing → chase RM
    ...
    -- CASE 108 Attempt 2: COMPLETE — proceed to N-2
...
VALUES
    -- CASE 101: GTA v4.2 — current, all schedules present
    (1, 'AO-2026-000101', 1,
    ...
    -- CASE 108 Attempt 1: GTA missing entirely
    (2, 'AO-2026-000108', 1,
     NULL, 'GTA v4.2', FALSE,
     '["Schedule 7A - Futures"]',
     '[]', '["Schedule 7A - Futures"]',
    ...
    -- CASE 108 Attempt 2: GTA now present and valid
    (3, 'AO-2026-000108', 2,
     'GTA v4.2', 'GTA v4.2', TRUE,
     '["Schedule 7A - Futures"]',
     '["Schedule 7A - Futures"]',
...
-- --------------------------------------------------------------------------
-- 7. Additional staged documents for CASE 108 Attempt 2 resubmission
--    (These go into the SA-1 shared table dce_ao_document_staged)
-- --------------------------------------------------------------------------
...
-- -----------------------------------|------|-------------------------------------
-- dce_ao_document_checklist          |    6 | 101(1), 104(1), 105(1), 106(1), 108(2)
-- dce_ao_document_checklist_item     |   27 | 101(11), 108-att1(8), 108-att2(8)
-- dce_ao_document_ocr_result         |    8 | 101(2), 108-att1(2), 108-att2(4)
-- dce_ao_document_review             |   10 | 101(2), 108-att1(2), 108-att2(6)
-- dce_ao_completeness_assessment     |    6 | 101(1), 104(1), 105(1), 106(1), 108(2)
-- dce_ao_gta_validation              |    3 | 101(1), 108(2)
-- dce_ao_document_staged (SA-1 ext)  |    4 | 108 resubmission docs
-- -----------------------------------|------|-------------------------------------
-- TOTAL                              |   64 |
--
-- ============================================================================
