...
## Variation Risk-Severity Routing (Deep Knowledge Section 3.2)

Once a product is classified as a **Variation**, the following risk-severity routing determines the exact approval track:

| Risk Severity | Approval Track | Examples |
|---------------|---------------|----------|
| **High-risk variation** | Full NPA | Accounting change, cross-book transfer, fintech-related variation |
| **Medium-risk variation** | NPA Lite | Minor bundling adjustment, adding a settlement option |
| **Low-risk variation** | NPA Lite Addendum | Typo correction, clarification of existing terms |

> **Note:** Consult Group Finance when in doubt about accounting treatment changes.

---

## Existing Product Sub-Categories & Routing Logic

When a product is classified as **Existing** (NTG Score = 0, VAR Score = 0), the following sub-categories determine the correct routing:

| Product Status | Condition | Routing / Approval Track | SLA |
|---------------|-----------|--------------------------|-----|
| **Active** | On Evergreen list | Evergreen (trade same day) | Same day |
| **Active** | NOT on Evergreen list | NPA Lite - Reference Existing | Standard |
| **Dormant (<3 years)** | Meets fast-track criteria | Fast-Track Dormant Reactivation | 48 hours |
| **Dormant (<3 years)** | Variations detected | NPA Lite | Standard |
| **Dormant (>=3 years)** | Any | Escalate to GFM COO (may need Full NPA) | Extended |
| **Expired** | No variations | NPA Lite - Reactivation | Standard |
| **Expired** | Variations detected | Full NPA (treated as effectively NTG) | Full NPA timeline |
